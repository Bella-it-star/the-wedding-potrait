...
<head>
    ...
    <title>Edit Tamu Undangan - Wedding Guest</title>
        ...
        <div class="row justify-content-center">
            <div class="col-md-6">
                ...
                <div class="card card-custom p-4">
                    <h2 class="fs-3 fw-bold mb-2"><i class="fa-solid fa-user-pen me-2" style="color: #7f5af0;"></i>Edit Data Tamu</h2>
                    <p class="text-muted small mb-4">Perbarui informasi detail mengenai tamu undangan sesuai dengan kolom database.</p>
                    ...
                    <form action="{{ route('guests.update', $guest->id) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="name" class="form-control bg-light py-2" value="{{ old('name', $guest->name) }}" required placeholder="Contoh: Andi Wijaya">
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" name="invited_count" class="form-control bg-light py-2" value="{{ old('invited_count', $guest->invited_count) }}" min="1" required>
                            </div>

                            <!-- NOMOR TELEPON -->
                            <div class="col-md-6 mb-3">
                                <label class="form-label fw-bold text-dark small">Nomor HP / WhatsApp</label>
                                <input type="text" name="phone" class="form-control bg-light py-2" value="{{ old('phone', $guest->phone) }}" placeholder="Contoh: 08123456xxx">
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select name="category" class="form-select bg-light py-2">
                                    <option value="Reguler" {{ old('category', $guest->category) == 'Reguler' ? 'selected' : '' }}>Reguler</option>
                                    <option value="VIP" {{ old('category', $guest->category) == 'VIP' ? 'selected' : '' }}>VIP</option>
                                    <option value="VVIP" {{ old('category', $guest->category) == 'VVIP' ? 'selected' : '' }}>VVIP</option>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" name="table_number" class="form-control bg-light py-2" value="{{ old('table_number', $guest->table_number) }}" placeholder="Contoh: V-01 atau B-12">
                            </div>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="notes" class="form-control bg-light py-2" rows="3" placeholder="Tulis catatan di sini (misal: Teman kantor ayah, bawa anak kecil, dll)...">{{ old('notes', $guest->notes) }}</textarea>
                        </div>
